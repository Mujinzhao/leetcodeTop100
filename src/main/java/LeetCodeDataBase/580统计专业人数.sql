...
select D.dept_name as dept_name,ifnull(T.student_number,0) as student_number
from department D left join
(select D.dept_id as dept_id ,D.dept_name as dept_name,count(*) as student_number
from student S left join department D on S.dept_id = D.dept_id
group by D.dept_id) as T
